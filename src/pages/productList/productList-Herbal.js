import './prodductList-Herbal.scss';
...
function ProductListHerbal() {
  ...
  const collection2 = details.filter((item) => item.product_collection === 2);
  const productDetail = details.filter((item) => item.id === productID);

  return (
    <>
      <div className="herbalAll">
        <div className="herbal">
          <div className="herbal_title">
            植物調理系列
            <br></br>
            Herbal Product Collection
          </div>
          <div className="herbal_content">
...
export default ProductListHerbal;
