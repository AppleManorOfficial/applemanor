...
function ProductListGift() {
  ...
  const collection4 = details.filter((item) => item.product_collection === 4);
  const productDetail = details.filter((item) => item.id === productID);
  return (
    <>
      <div className="giftBoxAll">
...
export default ProductListGift;
