import './prodcutList-HandMade.scss';
...
function ProductListHandMade() {
  ...
  const collection1 = details.filter((item) => item.product_collection === 1);
  const productDetail = details.filter((item) => item.id === productID);

  return (
    <>
      <div className="handMadeAll">
        <div className="handMade">
          <div className="handMade_title">
            手工皂系列
            <br></br>
...
export default ProductListHandMade;
